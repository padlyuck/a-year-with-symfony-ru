...
Каждый бандл должен иметь имя, котрое отражает его назначение. Например, у вас могут быть такие бандлы: 
...
Подробнее о конфигурировании бандлов вы узнаете в следующем разделе - [Шаблоны внедрения зависимостей](#patterns-of-dependency-injection). 
...
кто сможет создать объект Response для  (см. также главу [Обработка исключений](#TODO)).