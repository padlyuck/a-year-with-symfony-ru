...
Перед тем, как вы решите изменить свой класс для использования сервисного контейнера напрямую, пожалуйста ознакомьтесь с разедами [Уменьшаем связность кода с фреймворком](#TODO), особенно [заметку быстродействии](#TODO).
